...
public class DragonController : MonoBehaviour
{
    ...
    private void InitializeDragon()
    {
        ...
        _ConfDragon = DragonManager.Instance.GetDragonConf(0);
    ...
    private void CreateJoints()
    {
        ...
        DragonManager.Instance.AttackDragonJoints = allDragonJoints.Where(j => j.GetColorType() != ColorType.None).ToArray();
    }
    ...
    private List<DragonJoint> CreateBody(int jointNum, int[] colorTypes, int[] jointIds, ref int index)
    {
        ...
        for (int i = 0; i < jointNum; i++)
        {
            ...
            ConfDragonJoint conf = DragonManager.Instance.GetDragonJointConf(jointIds[i]);
